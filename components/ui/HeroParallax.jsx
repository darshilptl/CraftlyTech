...
export const HeroParallax = ({ products }) => {
  ...
  const translateY = useSpring(
    useTransform(scrollYProgress, [0, 0.2], [-600, 10]),
    springConfig
  );
  return (
    <>
  ...
  return (
    <>
      <motion.div
        ...
        key={product.title}
        className="group/product h-64 w-[24rem] relative flex-shrink-0 rounded-lg overflow-hidden"
      >
        <Link
          href={product.link}
...
const TeamBeamSection = () => {
  return (
    <>
      <div className=" p-4 rounded-lg shadow-md mt-12 mr-14 absolute top-0 right-0">
