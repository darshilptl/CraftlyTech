...
export function Footer() {
  return (
    <footer className="bg-gray-900 text-white py-12 md:py-16 lg:py-20">
      <div className="container mx-auto max-w-7xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        <div className="flex flex-col items-start gap-4">
          <Link className="flex items-center gap-2" href="#">
            ...
            <span className="text-lg font-semibold">CraftlyTech</span>
          </Link>
      ...
      <div className="container mx-auto max-w-7xl mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 px-4 sm:px-0">
        <div className="flex items-center gap-2">
          <span className="text-gray-500 dark:text-gray-400 text-lg">Follow Us :</span>
        ...
        <p className="text-gray-500 dark:text-gray-400">
          © 2024 CraftlyTech. All rights reserved.
        </p>
      </div>
    </footer>
  );
